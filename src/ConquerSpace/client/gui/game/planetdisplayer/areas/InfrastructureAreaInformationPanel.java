 ...
 * @author EhWhoAmI
 */
public class InfrastructureAreaInformationPanel extends AreaInformationPanel<InfrastructureArea> {

    public InfrastructureAreaInformationPanel(InfrastructureArea area, GameState gameState) {
