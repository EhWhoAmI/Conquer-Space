 ...
 * @author EhWhoAmI
 */
public class CapitolAreaInformationPanel extends AreaInformationPanel<CapitolArea> {

    public CapitolAreaInformationPanel(CapitolArea area, GameState gameState) {
