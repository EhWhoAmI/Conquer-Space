    ...
    public void doBehavior() {
        ...
        for (ObjectReference ad : org.region.bodies) {
            ...
            if (admin instanceof City) {
                ...
                HashMap<StorableReference, Double> resourcesToSpend = new HashMap<>();
                for (Map.Entry<StorableReference, Double> entry : fromCity.resourceDemands.entrySet()) {
                ...
                for (ObjectReference ad2 : org.region.bodies) {
                    ...
                    if (!Objects.equals(ad2, ad) && admin2 instanceof City) {
                        ...
                        for (Map.Entry<StorableReference, Double> entry : candidateResourceCity.resourceDemands.entrySet()) {
                            StorableReference key = entry.getKey();
                            Double val = entry.getValue();
