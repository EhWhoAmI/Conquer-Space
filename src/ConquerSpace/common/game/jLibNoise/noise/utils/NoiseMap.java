...
public class NoiseMap {
     ...
     * @throws ConquerSpace.common.game.jLibNoise.noise.ExceptionInvalidParam
     *          See the preconditions.
     * @throws ConquerSpace.common.game.jLibNoise.noise.ExceptionOutOfMemory
     *          Out of memory.
...
//        return m_pNoiseMap + (long) x + (long) m_stride * (long) y;
     ...
     *
     * throws ExceptionOutOfMemory Out of memory.  (Yes, this
...
//        delete[] m_pNoiseMap;
     ...
     *  The noise map buffer must not exist.
     */
