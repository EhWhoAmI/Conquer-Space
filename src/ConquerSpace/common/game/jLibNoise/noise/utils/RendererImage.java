 ...
 * off every 'zig'.)
 */
package ConquerSpace.common.game.jLibNoise.noise.utils;

import ConquerSpace.common.game.jLibNoise.noise.ExceptionInvalidParam;
import ConquerSpace.common.game.jLibNoise.noise.Interp;
import ConquerSpace.common.game.jLibNoise.noise.MathConst;
import ConquerSpace.common.game.jLibNoise.noise.Misc;
...
public class RendererImage {
     ...
     * @throws ConquerSpace.common.game.jLibNoise.noise.ExceptionInvalidParam See the
     * preconditions. No two gradient points have the same position.
     */
    ...
    /**
     * Returns the azimuth of the light source, in degrees. The azimuth is the
     * location of the light source around the horizon: - 0.0 degrees is east. -
     ...
     *
     * @throws ConquerSpace.common.game.jLibNoise.noise.ExceptionInvalidParam See the
     * preconditions. SetSourceNoiseMap() has been previously called.
     * SetDestImage() has been previously called. There are at least two
     * gradient points in the color gradient. No two gradient points have the
     * same position. If a background image was specified, it has the exact same
     ...
     * @throws ConquerSpace.common.game.jLibNoise.noise.ExceptionInvalidParam See the
     * preconditions. The specified light contrast is positive.
     */
